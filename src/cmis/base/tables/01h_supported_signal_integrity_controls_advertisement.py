    ...
    "Table": {
        161: {
            ...
            2: {
                ...
                "Type": ["RO", "Rqd"],
                "Values": {
                    0: ("Tx Input Eq Fixed Manual control not supported", "NOT_SUPPORTED"),
            ...
            1: {
                ...
                "Type": ["RO", "Rqd"],
                "Values": {
                    0: ("If a Tx CDR is supported, it cannot be bypassed", "NOT_BYPASSABLE"),
        ...
        162: {
            ...
            (4, 3): {
                ...
                "Values": {
                    ...
                    0b01: ("Rx Output Eq Pre-cursor control supported", "PRE_CURSOR_SUPPORTED"),
                    0b10: ("Rx Output Eq Post-cursor control supported", "POST_CURSOR_SUPPORTED"),
                    0b11: ("Rx Output Eq Pre- and Post-cursor control supported", "BOTH_SUPPORTED")
                }
            },
            2: {
